            ...
            <div className="px-4 py-6 space-y-6">
              ...
              <div className="space-y-2 pt-4 border-t border-gray-200">
                <Link
                  href="/cart"
                  onClick={() => setIsOpen(false)}
                  className="flex items-center justify-between px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors"
                >
              ...
              {/* User Section / Auth Buttons - AT BOTTOM */}
              {isAuthenticated && user ? (
                ...
                <div className="pt-4 border-t border-gray-200 space-y-2">
                  <Link
                    href="/login"
                    onClick={() => setIsOpen(false)}
                    className="flex items-center justify-center gap-2 px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors"
                  >
                  ...
                  <Link
                    href="/register"
                    onClick={() => setIsOpen(false)}
                    className="flex items-center justify-center gap-2 px-4 py-3 bg-[#F57C00] hover:bg-[#E67000] text-white rounded-lg transition-colors"
                  >
                    Sign Up
                  </Link>
                </div>
